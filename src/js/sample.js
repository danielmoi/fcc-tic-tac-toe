  ...
  compTurn: function compTurn() {
    ...
    function block() {
      ...
      for (var i = 0; i < winCombos.length; i++) {
        ...
        for (var array in winnersObj) {
          if (playerMoved(winnersObj[array][0]) && playerMoved(winnersObj[array][1]) && blank(winnersObj[array][2])) {
            return winnersObj[array][2];
          } else if (playerMoved(winnersObj[array][1]) && playerMoved(winnersObj[array][2]) && blank(winnersObj[array][0])) {
            return winnersObj[array][0];
          } else if (playerMoved(winnersObj[array][0]) && playerMoved(winnersObj[array][2]) && blank(winnersObj[array][1])) {
    ...
    function didPlayerBlock() {
      ...
      for (var i = 0; i < winCombos.length; i++) {
        var winnersObj = winCombos[i];
        for (var array in winnersObj) {
          if (checkComp(winnersObj[array][0]) && checkComp(winnersObj[array][1]) && checkPlayer(winnersObj[array][2])) {
            return true;
          } else if (checkComp(winnersObj[array][1]) && checkComp(winnersObj[array][2]) && checkPlayer(winnersObj[array][0])) {
            return true;
          } else if (checkComp(winnersObj[array][0]) && checkComp(winnersObj[array][2]) && checkPlayer(winnersObj[array][1])) {
            return true;
          }
        }
      }
    ...
    function doWin() {
      ...
      for (var i = 0; i < winCombos.length; i++) {
        var winnersObj = winCombos[i];
        for (var array in winnersObj) {
          if (compMoved(winnersObj[array][0]) && compMoved(winnersObj[array][1]) && blank(winnersObj[array][2])) {
            return winnersObj[array][2];
          } else if (compMoved(winnersObj[array][1]) && compMoved(winnersObj[array][2]) && blank(winnersObj[array][0])) {
            return winnersObj[array][0];
          } else if (compMoved(winnersObj[array][0]) && compMoved(winnersObj[array][2]) && blank(winnersObj[array][1])) {
            return winnersObj[array][1];
